...
window.__K9TRAINING__ = {
  ...
  services: [
    ...
    },
    {
      ...
      videos: ["obediencia-avancada-1.mp4"],
  ...
  plans: [
    {
      name: "Aula avulsa",
      summary: "Aula personalizada para dúvidas, ajustes pontuais e primeira avaliação.",
      ideal: "Para tutores que querem orientação sem contratar um plano completo.",
      price: "R$ 200",
      priceDetail: "Aula individual."
    },
    {
    ...
    },
    {
      ...
      priceOptions: [
        { label: "2x por semana", value: "R$ 900/mês", detail: "Duas aulas semanais na residência do tutor." },
        { label: "3x por semana", value: "R$ 1.200/mês", detail: "Três aulas semanais na residência do tutor." }
      ]
    }
  ],
