  ...
  services: [
    {
      ...
      videos: ["obediencia-basica-1.mp4", "obediencia-basica-2.mp4"],
      ...
      detailList: ["Xixi e cocô no local certo", "Senta", "Deita", "Fica", "Junto", "Chamado", "Controle de impulsos", "Socialização", "Correção de comportamentos indesejados", "Técnicas de recompensa e motivação"],
      cta: "Quero começar"
    },
    {
    ...
    },
    {
      ...
      plans: [
        ...
        },
        {
          ...
          priceOptions: [
            { label: "2 aulas por semana", value: "R$ 900/mês" },
            { label: "3 aulas por semana", value: "R$ 1.200/mês" }
          ]
        },
        {
          name: "Consultoria online",
