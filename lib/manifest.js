...
window.__K9TRAINING__ = {
  ...
  gallery: [
    { img: "k9-1.webp", alt: "Cão em obediência avançada ao lado do condutor" },
    { img: "k9-2.webp", alt: "Treinamento de guarda e proteção" },
    { img: "k9-3.webp", alt: "Obediência ao ar livre, cão em foco" },
    { img: "k9-4.webp", alt: "Cão farejador em trabalho de detecção" },
    { img: "k9-5.webp", alt: "Trabalho de mordida com equipamento" },
    { img: "k9-6.webp", alt: "Proteção veicular com cão de guarda" },
    { img: "k9-7.webp", alt: "Detecção de entorpecentes, busca dirigida" },
    { img: "k9-8.webp", alt: "Defesa do condutor em campo" },
    { img: "k9-9.webp", alt: "Obediência sob controle, alta performance" }
  ],
