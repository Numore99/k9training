...
window.__K9TRAINING__ = {
  ...
  gallery: [
    { img: "k9-1.webp", alt: "Guarda e proteção, controle do cão" },
    { img: "k9-2.webp", alt: "Obediência avançada com foco" },
    { img: "k9-3.webp", alt: "Cão trabalhando junto ao condutor" },
    { img: "k9-4.webp", alt: "Controle na caixa de referência" },
    { img: "k9-5.webp", alt: "Obediência e permanência" },
    { img: "k9-6.webp", alt: "Detecção de entorpecentes" },
    { img: "k9-7.webp", alt: "Trabalho técnico individualizado" },
    { img: "k9-8.webp", alt: "Treino em plataforma" },
    { img: "k9-9.webp", alt: "Socialização e estabilidade" }
  ],
