...
window.__K9TRAINING__ = {
  ...
  /* VÍDEO DE CADA SERVIÇO (opcional):
     - O botão "Ver vídeo" só aparece no serviço que tiver a linha "video".
     - Coloque o arquivo .mp4 dentro da pasta:  assets/video/serv/
     - Escreva aqui apenas o NOME do arquivo. Ex:  video: "obediencia-basica.mp4"
     - Para esconder o botão de um serviço, apague a linha "video" dele
       (ou deixe em branco assim:  video: "").
     Enquanto o arquivo não existir, o botão mostra "Vídeo em breve". */
  services: [
    {
      name: "Obediência básica",
      video: "obediencia-basica.mp4",
    ...
    },
    {
      ...
      video: "deteccao-entorpecentes.mp4",
    ...
    },
    {
      ...
      video: "internato-adestramento.mp4",
